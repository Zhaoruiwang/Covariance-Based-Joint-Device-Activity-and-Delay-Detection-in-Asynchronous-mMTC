function [gamma_vec, MeanM, mse,mse_g,LF,LF_true,errStep, t] = mSBLearningCovML_new(A,Y,sigma2,N_iter,gamma_act)
...
%     end
    ...
    g = grad(gamma_vec, A, sampCov, sigma2);
    
    if norm(max(gamma_vec - g, 0) - gamma_vec) < epsilon
        break
    end
